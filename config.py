# version = '3.0.1.7663921'
version = '3.0.1'
game = f'V{version} | >h|$h'
env = 'dev'

tdb_settings = dict(
    credentials=dict(
        discord=dict(
            token='NTcwMjIzMDY1NTMxOTQwODY0.XL8DpA.FQBvLZA8S46p9MJ3FC1F0xNQgkc',
        )
    ),
    database=dict(
        dev=dict(
            ...
            username='tdb',
            password='C9d5cqv4AWPE6EQs',
            database='tdb',
            location='tfa-software.com',  # Server windows
        ),
        prod=dict(
            type='sqlite3',
            database_name='tdr.sqlite3',
...
backup_locations = 'C:\\Users\\Administrator\\Desktop\\TDR\\the-dark-rewrite'
...
assets = dict(
    ...
    cuddling=[
        'assets/cuddle/p1.gif',
        'assets/cuddle/p2.gif',
    ],
    thumbs_up=[
        'assets/thumbs_up/p1.gif'
    ],
    blushing=[
        'assets/blush/p1.gif',
        'assets/blush/p2.gif',
